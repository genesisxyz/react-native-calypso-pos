...
public final class CardUpdateRecordParser extends AbstractCardResponseParser {
   ...
   * @since 2.0.0
   */
  public CardUpdateRecordParser(ApduResponseApi response, CardUpdateRecordBuilder builder) {
